    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between pb-2 mb-2">
                <h5 class="card-title">Add Item Data</h5>
                <div>
            ...
            <form @submit.prevent="addItem" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="tel" class="form-control" v-model="phone_number" placeholder="Add number e.g. +959xxxxxxxxx">
                    <!-- <vue-tel-input v-model="phone_number" mode="international"></vue-tel-input> -->
                </div>
                ...
                <button type="submit" class="btn btn-primary mx-2 mt-4 mb-4"> Add Item</button>
            </form>
...
export default{
    ...
    methods: {
        ...
        onChangeItemCondition(e) {
            ...
            console.log('Selected ItemCondition:',  e.target.options[e.target.selectedIndex].text);
        },
        onChangeItemType(e) {
            this.selectedItemType = e.target.options[e.target.selectedIndex].text;
            console.log('Selected ItemType:',  e.target.options[e.target.selectedIndex].text);
        },
        onChangeImage(e) {
        ...
        addItem(e) {
            this.$axios.get('/sanctum/csrf-cookie').then(response => {
                ...
                this.$axios.post('/api/items/add', formData, config)
                .then(response => {
